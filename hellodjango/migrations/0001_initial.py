# Generated by Django 2.0.7 on 2018-07-14 09:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.ForeignKey(db_column='sno', on_delete=django.db.models.deletion.PROTECT, related_name='+', to='hellodjango.Subject', verbose_name='所属学科')),
            ],
            options={
                'verbose_name': '讲师',
